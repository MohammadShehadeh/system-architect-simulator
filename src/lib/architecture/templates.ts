...
export const TEMPLATES: Template[] = [
  ...
  buildTemplate(
    ...
    [
      ...
      { ref: "cdn", type: "cdn", x: COL, y: ROW * 2, overrides: { hitRate: 0.95, edgeLocations: 300, ttlSeconds: 86400 } },
      { ref: "gw", type: "api-gateway", x: COL * 2, y: ROW * 2 },
      ...
      { ref: "videos", type: "object-storage", x: COL * 4, y: ROW * 2, overrides: { storageGB: 500000, multiRegion: true, avgObjectSizeKB: 4096 } },
